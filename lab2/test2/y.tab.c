...
{
  "$end", "error", "$undefined", "ADD", "SUB", "MUL", "DIV", "LEFTP",
  "RIGHTP", "NUMBER", "UMINUS", "equal", "ID", "';'", "$accept", "lines",
  "expr", YY_NULLPTR
};
#endif
...
#line 1394 "y.tab.c"
  ...
  case 12:
#line 64 "pro1.y"
                                { (yyvsp[-2].TabP)->value=(yyvsp[0].val); (yyval.val)=(yyvsp[0].val);}
#line 1400 "y.tab.c"
    break;

  case 13:
#line 65 "pro1.y"
                     {(yyval.val)=(yyvsp[0].TabP)->value;}
#line 1406 "y.tab.c"
    break;
